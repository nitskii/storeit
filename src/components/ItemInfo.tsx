        ...
        <div class='space-y-2'>
          <div class='flex space-x-2 items-center'>
            <h2
              ...
              {...{ 'hx-on::before-swap': 'handleNameUpdateResult(event)' }}>
              {item.name}
            </h2>
            <button
              class='p-2 cursor-pointer'
              onclick='showNameUpdateModal()'>
              <img
          ...
          <div class='flex space-x-2 items-center'>
            <h3
              ...
              {...{ 'hx-on::after-request': 'handleLocationUpdateResult(event)' }}>
              {item.location}
            </h3>
            <button
              class='p-2 cursor-pointer'
          ...
          <div class='flex'>
            <ul
              ...
              {...{ 'hx-on::before-swap': 'handleTagUpdateResult(event)' }}>
