  ...
  <>
    ...
    <html class="h-full bg-orange-50">
      <head>
        ...
        <script hx-preserve="true" defer src="/public/htmx.min.js" />
        <script hx-preserve="true" defer src="/public/base.js" />
        <script hx-preserve="true" defer src="https://unpkg.com/htmx.org/dist/ext/head-support.js" />
      </head>
      <body
