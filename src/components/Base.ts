                  ...
                  <form class="space-y-4 md:space-y-6">
                      <div>
                          ...
                          <input
                              ...
                              name="nickname"
                              id="nickname"
                              class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-primary-600 focus:outline-none focus:ring-primary-600 sm:text-sm"
                              required="" />
                      </div>
                      <div>
                          <label
